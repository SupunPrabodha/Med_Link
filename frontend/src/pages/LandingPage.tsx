...
export function LandingPage() {
	return (
		<div className="relative min-h-screen bg-white">
			<div className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(900px_circle_at_20%_10%,rgba(16,185,129,0.18),transparent_60%),radial-gradient(700px_circle_at_80%_0%,rgba(16,185,129,0.12),transparent_55%),linear-gradient(to_bottom,rgba(255,255,255,1),rgba(240,253,250,0.45),rgba(255,255,255,1))]" />

			<div className="mx-auto max-w-6xl px-4 py-10 sm:py-12">
				<header className="flex items-center justify-between gap-4">
					<div className="flex items-center gap-3">
						<div className="grid h-10 w-10 shrink-0 place-items-center rounded-xl bg-emerald-600 text-sm font-semibold text-white shadow-sm ring-1 ring-emerald-600/20">
							ML
						</div>
						<div>
				...
				<main className="mt-10 grid gap-6 lg:grid-cols-12 lg:gap-8">
					<section className="lg:col-span-7">
						<div className="inline-flex items-center gap-2 rounded-full border border-emerald-100 bg-white/70 px-3 py-1 text-xs font-medium text-emerald-700 shadow-sm">
						...
						<div className="mt-7 grid gap-3 sm:grid-cols-2">
							<div className="flex items-start gap-3 rounded-xl border border-slate-100 bg-white/70 p-4 shadow-sm">
					...
					<aside className="lg:col-span-5">
						<Card className="border-emerald-100 bg-white/80 shadow-sm backdrop-blur">
							...
							<div className="mt-6 rounded-xl border border-slate-100 bg-white/70 p-4">
